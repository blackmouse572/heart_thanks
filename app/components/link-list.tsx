...
import { Icon as NativeIcon } from './ui/icon'
import type { ReactNode } from 'react'
import { twMerge } from 'tailwind-merge'
import Button from './ui/button'
import { cn } from '#app/utils/misc.js'
import { cloneElement } from '#app/utils/ui.js'
...
export const Trigger = ({ children }: { children: ReactNode }) => (
	<Accordion.Header>
		...
		>
			...
			<NativeIcon
				name="chevron-down"
				className="ease-[cubic-bezier(0.87,_0,_0.13,_1)] ml-auto size-4 opacity-75 transition-transform duration-300 group-data-[state=open]:rotate-180"
			/>
		</Accordion.Trigger>
	</Accordion.Header>
)
