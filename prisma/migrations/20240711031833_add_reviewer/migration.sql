...
INSERT INTO "new_Transactions" ("amount", "content", "createdAt", "id", "ownerId", "receiverId", "title", "updatedAt") SELECT "amount", "content", "createdAt", "id", "ownerId", "receiverId", "title", "updatedAt" FROM "Transactions";
