...
INSERT INTO "new_Transactions" ("amount", "content", "createdAt", "id", "ownerId", "receiverId", "reviewed", "reviewedAt", "reviewedById", "status", "title", "updatedAt") SELECT "amount", "content", "createdAt", "id", "ownerId", "receiverId", "reviewed", "reviewedAt", "reviewedById", "status", "title", "updatedAt" FROM "Transactions";
